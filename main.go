...
func signin(w http.ResponseWriter, r *http.Request) {
	//in original lines 63-72 should be removed
...
func directoryUsers(w http.ResponseWriter, r *http.Request) {
	...
	directoryID := os.Getenv("WORKOS_DIRECTORY_ID")
	//var somedirectory directorysync.ListUsersResponse
	...
	data := usersFromDirectory.Data
	// var newDirectoryUser directorysync.User
	var users [][]string
	for _, newDirectoryUser := range data {

		users = append(users, []string{newDirectoryUser.FirstName, newDirectoryUser.LastName, newDirectoryUser.Username, newDirectoryUser.DirectoryID})
...
func main() {
	...
	router.HandleFunc("/users", directoryUsers)
